        ...
        for region in ["com", "de", "co.uk", "fr"]:
            ...
            if region == 'com':
                ...
                date_time = datetime.now(pytz.timezone('America/New_York')).replace(minute=0, second=0, microsecond=0,
                                                                                    tzinfo=None)
                bot_usa.send_message(os.getenv('CHANNEL_ID_USA'), message_test, parse_mode='HTML')
                postal_code = '10019'
                ...
                date_time = datetime.now(pytz.timezone('Europe/Berlin')).replace(minute=0, second=0, microsecond=0,
                                                                                 tzinfo=None)
                bot_de.send_message(os.getenv('CHANNEL_ID_DE'), message_test, parse_mode='HTML')
                postal_code = "10115"
                ...
                date_time = datetime.now(pytz.timezone('Europe/Paris')).replace(minute=0, second=0, microsecond=0,
                                                                                tzinfo=None)
                bot_fr.send_message(os.getenv('CHANNEL_ID_FR'), message_test, parse_mode='HTML')
                postal_code = "75000"
                ...
                date_time = datetime.now(pytz.timezone('Europe/London')).replace(minute=0, second=0, microsecond=0,
                                                                                 tzinfo=None)
                bot_uk.send_message(os.getenv('CHANNEL_ID_UK'), message_test, parse_mode='HTML')
